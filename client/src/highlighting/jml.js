 ...
 **/
ace.define(
  // we tell ace, that we want to define our own ace extension module
      ...
      this.getFoldWidgetRange = function(
        ...
        session.getCommentFoldRange = function(row, column, dir) {
          ...
          if (type === 'jml_comment') {
            ...
            range.end.column =
              iterator.getCurrentTokenColumn() + token.value.indexOf('@*/');
            return range;
          } else {
        ...
        return CStyleFoldMode.prototype.getFoldWidgetRange.call(
          this,
          session,
          foldStyle,
          row,
 ...
 */
ace.define(
  // see above, for how this define call works.
  'ace/mode/jml',
  function(acequire, exports, module) {
    // acequire imports ace modules
    var oop = acequire('../lib/oop');
    var JavaScriptMode = acequire('./javascript').Mode;
    var JavaHighlightRules = acequire('ace/mode/custom_java_highlight_rules')
      .JavaHighlightRules;
    ...
    (function() {
      ...
      this.getNextLineIndent = function(state, line, tab) {
        if (state === 'jml-block-specs') {
          ...
          return JavaScriptMode.prototype.getNextLineIndent.call(
            this,
            state,
            line,
            tab
