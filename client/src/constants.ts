...
const activeConfig = (() => {
  ...
  if (staticConfiguration != null) {
    return {
      serverAddress:
        staticConfiguration.serverAddress != null
          ? staticConfiguration.serverAddress
          : defaultConfig.serverAddress,
      permanentEditHighlighting:
        staticConfiguration.permanentEditHighlighting != null
          ? staticConfiguration.permanentEditHighlighting
          : defaultConfig.permanentEditHighlighting,
    };
  } else {
...
export const permanentEditHighlighting: boolean =
  activeConfig.permanentEditHighlighting;
