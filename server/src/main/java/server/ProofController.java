...
public class ProofController {
  ...
  @ResponseBody
  public ResponseEntity<ProofResult> proveSpec(
      @PathVariable String className, HttpServletRequest request) {
      ...
      try {
        ...
        KeYEnvironment<?> env =
            KeYEnvironment.load(
                ...
                classPaths,
                bootClassPath,
                includes); // env.getLoadedProof() returns performed proof if a *.proof file is
        // loaded
        try {
          ...
          for (Contract contract : proofContracts) {
            ...
            try {
              ...
              sp.setProperty(
                  StrategyProperties.METHOD_OPTIONS_KEY, StrategyProperties.METHOD_CONTRACT);
