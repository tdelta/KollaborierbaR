...
/**
 * Can indicate any change to a project structure and should trigger a project structure reload on
 * the client.
 *
 * <p>Currently it is only used to inform clients about new files added to the project.
 *
