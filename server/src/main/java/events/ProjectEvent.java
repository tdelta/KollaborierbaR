...
/**
 * The {@link server.ProjectController} communicates changes to projects stored
 * on the server to {@link synchronization.ProjectSyncController} by sending it
 * instances of this class's subclasses.
 *
 * <p>It is also sent by {@link synchronization.ProjectSyncController} to clients, to inform them
 * about the changes.
 *
 * <p>This class just contains data which describes, which project is affected by a change.
 * The subclasses encode, what kind of change happened, by
