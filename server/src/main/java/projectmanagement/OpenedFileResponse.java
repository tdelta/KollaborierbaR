...
/**
 * Contains contents of a file and metadata (filename). It is meant to be used as a data container
 * for Java Spring Marshalling, so that file contents can be sent to clients.
 *
 * @author Marc Arnold
 */
